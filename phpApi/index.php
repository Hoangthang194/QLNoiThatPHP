                ...
                <nav class="header__navbar">
                    <ul class="header__navbar-list">
                        <li class="header__navbar-item header__navbar-item--has-qr header__navbar-item--separate">
                            <a href="./AdminInterface/index.html" class="header-link" target="_blank">Kênh admin</a>
                        </li>
                    ...
                    <ul class="header__navbar-list">
                        ...
                        <li class="header__navbar-item header__navbar-user">
                            ...
                            <span class="header__navbar-user-name">Thắng Hoàng</span>
                            ...
                            <ul class="header__navbar-user-menu">
                                ...
                                <li class="header__navbar-user-item header__navbar-user-item--separate">
                                    <a href="./Partials/login.html">Đăng xuất</a>
                                </li>
                            </ul>
                        </li>
                    </ul>
                ...
                <div class="header-with-search">
                    <div class="header__logo">
                        <a href="/" class="header__logo-link">
                            <img src="./access/img/logo-nha-xinh-moi-200422.png" alt="">
                        </a>
                    </div>
...
<script src="access/js/description.js"></script>
<script src="access/js/notification.js"></script>
<script src="access//js/cart.js"></script>
<script src="./access/js/calendar.js"></script>
<?php
