        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <li class="nav-item">
              ...
              <li class="nav-item">
                <a href="./partial/insert.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Thêm sản phẩm</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="./partial/update.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Cập nhật thông tin</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="./partial/delete.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Xóa sản phẩm</p>
                </a>
              </li>
          ...
          <li class="nav-item">
            <a href="./partial/message.php" class="nav-link active">
