...
<div class="wrapper">
  ...
  <!-- Add Item Form -->
  <form id="addItemForm" method="post" action="../app/controller/insert.php">
  <div class="mb-3">
...
<div class="row gx-5">
    ...
    <label for="materialproduct" class="form-label">Loại sản phẩm</label>
      <select class="form-select" aria-label=".form-select-lg example" name="TypeProduct">
    ...
    <select class="form-select" aria-label=".form-select-lg example" name="TypeRoom">
...
<div class="mb-3">
  <div class="row gx-5">
    <div class="col">
      ...
      <input type="text" class="form-control" id="priceproduct" placeholder="Kích thước" required name="Acreage">
    </div>
    <div class="col">
    ...
    <div class="row gx-5" style="display: flex; align-items: center;">
      ...
      <div class="col">
      <div class="form-check">
      <input class="form-check-input" type="radio" id="flexRadioDefault1" name="state" value="Đã đặt">
      <label class="form-check-label" for="flexRadioDefault1">
        Đã đặt
      </label>
</div>
